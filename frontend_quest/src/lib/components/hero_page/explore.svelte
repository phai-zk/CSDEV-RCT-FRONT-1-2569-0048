<script lang="ts">
	...
	let { emojis, isLoading = $bindable() } = $props();
</script>

<p class="py-3 text-center text-2xl">Explore</p>
...
<div
	...
	id="explore"
	class="grid min-h-128 w-full grid-cols-9 gap-2.5 overflow-x-hidden overflow-y-auto rounded-xl bg-[#1F1F1F] p-4"
